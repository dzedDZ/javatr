 ...
 * Создать класс “Записная книжка”. Предусмотреть возможность работы
 с произвольным числом записей, пойска записи по какому-было
 признаку (например, по фамилии, дате рождения или номеру телефона),
 добавления и удаления записей, cортировки по разным полям.
 */
public class Notepad {
    public static void main(String args[]) {
    Notepad notepad = new Notepad();

    notepad.addRecord("Лукьян", "Егоров", 1995,11,30,"+12345678");
    notepad.addRecord("Ульяна", "Егорова", 1985,10,3,"+123454444678");
    notepad.addRecord("Петр", "Иванович",1975,1,31,"+123429044678");
        ...
        notepad.searchRecord("Ульяна");
        notepad.searchRecord("Егорова");
